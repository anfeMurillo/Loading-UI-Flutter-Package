...
final Map<String, LoaderBuilder> _loaders = {
  'DotsLoader': () => const DotsLoader(),
  'BouncingDotsLoader': () => const BouncingDotsLoader(),
  'BobbingDotsLoader': () => const BobbingDotsLoader(),
  'PulsatingDotsLoader': () => const PulsatingDotsLoader(),
  'TypingLoader': () => const TypingLoader(),
  'BarsLoader': () => const BarsLoader(),
  'WaveLoader': () => const WaveLoader(),
  'TextDotsLoader': () => const TextDotsLoader(child: Text('Loading')),
  'ClassicLoader': () => const ClassicLoader(),
  'DotsRingLoader': () => const DotsRingLoader(),
  'SpiralLoader': () => const SpiralLoader(),
  'TwinOrbitLoader': () => const TwinOrbitLoader(),
};
