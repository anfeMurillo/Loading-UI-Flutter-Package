...
class PrismSweepLoader extends StatelessWidget {
  final double? size;
  ...
  Widget build(BuildContext context) {
    return DotMatrixBase(
      ...
      animationResolver: (ctx) {
        ...
        final order = diagonalSnakeOrderValue(ctx.index);
        final pathNorm = diagonalSnakeNormFromIndex(ctx.index);
